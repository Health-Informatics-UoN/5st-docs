...
![DMN Rules screenshot](/DMNRules.png)
...
- Postgres 
- Trino (not yet tested)
- S3 (work in progress)
- Static credentials (as long as the container is able to accept the custom env variables)
</Callout>
